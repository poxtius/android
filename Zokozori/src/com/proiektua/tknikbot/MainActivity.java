...
public class MainActivity extends Activity implements SurfaceHolder.Callback, IVideoPlayer {
	...
	private ImageView  robotaren_bideoa, ps_argazkia, xtiond,xtionc,xtioni;
	private Button start_sentsoreak, aginduak;
	...
	private void setupWidgets ()
	{
		...
		robotaren_bideoa = (ImageView) this.findViewById(R.id.robotaren_bideoa);
		
		//Robota Bideo ImageView sakatzean argazkia atera eta ikuskatuko da.
		robotaren_bideoa.setOnClickListener( new OnClickListener() {		
			@Override
			public void onClick(View v) {
				...
				if (wifi){ //wifia konektaturik badago argazkia ateratzeko prozesua martxan jartzen da!
	                ...
	                try {
	                	...
	                	task.execute(new URI("http://10.15.181.25:8000/camera/psEyeWebcamP/?cam=1"), null, null);
	...
	//Ps Webcam2-tik argaztia ateratzea.
			...
			public void onClick(View v) {
				...
				if (wifi){ //wifia konektaturik badago argazkia ateratzeko prozesua martxan jartzen da!
	                ...
	                try {
	                	...
	                	//Asyntask-a martxan jartzen dugu Raspberry Pi-ko ApiRest-eko helbidea pasaz
	                	task.execute(new URI("http://10.15.181.25:8000/camera/psEyeWebcamP/?cam=2"), null, null);
			...
			public void onClick(View v) {
				...
				if (wifi){ //wifia konektaturik badago argazkia ateratzeko prozesua martxan jartzen da!
	                ...
	                try {
	                	...
	                	//Asyntask-a martxan jartzen dugu Raspberry Pi-ko ApiRest-eko helbidea pasaz
	                	task.execute(new URI("http://10.15.181.25:8000/camera/xtion/?type=d"), null, null);
			...
			public void onClick(View v) {
				...
				if (wifi){ //wifia konektaturik badago argazkia ateratzeko prozesua martxan jartzen da!
	                ...
	                try {
	                	...
	                	//Asyntask-a martxan jartzen dugu Raspberry Pi-ko ApiRest-eko helbidea pasaz
	                	task.execute(new URI("http://10.15.181.25:8000/camera/xtion/?type=c"), null, null);
			...
			public void onClick(View v) {
				...
				if (wifi){ //wifia konektaturik badago argazkia ateratzeko prozesua martxan jartzen da!
	                ...
	                try {
	                	...
	                	//Asyntask-a martxan jartzen dugu Raspberry Pi-ko ApiRest-eko helbidea pasaz
	                	task.execute(new URI("http://10.15.181.25:8000/camera/xtion/?type=i"), null, null);
		...
		aurrera.setOnClickListener( new OnClickListener() {
			...
			doGetPetition("http://10.15.181.25:8000/robota/mugimenduak/?state=au");
			}
		});
		...
		atzera.setOnClickListener( new OnClickListener() {
			...
			doGetPetition("http://10.15.181.25:8000/robota/mugimenduak/?state=at");
		...
		eskuinera.setOnClickListener( new OnClickListener() {
			...
			doGetPetition("http://10.15.181.25:8000/robota/mugimenduak/?state=es");
		...
		ezkerrera.setOnClickListener( new OnClickListener() {
			...
			public void onClick(View v) {
				...
				doGetPetition("http://10.15.181.25:8000/robota/mugimenduak/?state=ez");
		...
		stop.setOnClickListener( new OnClickListener() {
			...
			doGetPetition("http://10.15.181.25:8000/robota/mugimenduak/?state=g");
	    ...
	    protected void onPostExecute(Bitmap result)
	    {
	    	...
	    	if (argazkia!= null){
	    		if (argazki_widgeta == 1)
	    			robotaren_bideoa.setImageBitmap(argazkia);
		...
		public void run() {
			...
			((Activity) mContext).runOnUiThread(new Runnable() {
				...
				public void run() {
					...
					String strJSON = getResponse("http://10.15.181.25:1111/sensors/temp/ds/");
	   ...
	   public class MyTask extends AsyncTask<Void, Void, Void>
	    {
			...
			protected Void doInBackground(Void... params) {
				if (surface_widgeta==1)
					{
					String jsonStr = doGetPetition("http://10.15.181.25:8000/camera/piCameraS/start");
					try {
				...
				if (surface_widgeta==2)
					{
					String jsonStr = doGetPetition("http://10.15.181.25:8000/camera/psEyeWebcamS0/?state=on");
					try {
						JSONObject json = new JSONObject(jsonStr);
						if (json.has("streaming_url"))
							mStringUrl = json.getString("streaming_url");
	    ...
	    private void stopStreaming() {
			 ...
			 Thread th = new Thread(new Runnable() {
				...
				public void run() {
					if (surface_widgeta == 1)
						doGetPetition("http://10.15.181.25:8000/camera/piCameraS/stop/");	
					if (surface_widgeta == 2)
						doGetPetition("http://10.15.181.25:8000/camera/psEyeWebcamS0/?state=off");
					surface_widgeta = 0;
				}
			});
